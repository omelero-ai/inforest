...
internal sealed class DummyReporteRepository : IReporteRepository
{
    ...
    public Task<LiquidacionOutput> ObtenerLiquidacionOutputAsync(LiquidacionParametros parametros, CancellationToken ct = default)
        => Task.FromResult(new LiquidacionOutput());
    public Task<IReadOnlyList<LiquidacionRow>> ObtenerLiquidacionDocumentosAsync(LiquidacionParametros parametros, CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<LiquidacionRow>>([]);
    public Task<IReadOnlyList<LiquidacionSumaGrupoRow>> ObtenerLiquidacionSumasGrupoAsync(LiquidacionParametros parametros, CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<LiquidacionSumaGrupoRow>>([]);
    public Task<IReadOnlyList<LiquidacionTarjetaRow>> ObtenerLiquidacionTarjetasAsync(LiquidacionParametros parametros, CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<LiquidacionTarjetaRow>>([]);
    public Task<IReadOnlyList<LiquidacionTipoPedidoRow>> ObtenerLiquidacionTiposPedidoAsync(LiquidacionParametros parametros, CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<LiquidacionTipoPedidoRow>>([]);
    public Task<IReadOnlyList<LiquidacionOtroTipoRow>> ObtenerLiquidacionOtrosTiposAsync(LiquidacionParametros parametros, CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<LiquidacionOtroTipoRow>>([]);
    public Task<IReadOnlyList<ReporteFiltroOpcion>> ObtenerUsuariosActivosAsync(CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<ReporteFiltroOpcion>>([]);
    public Task<IReadOnlyList<ReporteFiltroOpcion>> ObtenerSectoresVentaAsync(CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<ReporteFiltroOpcion>>([]);
    public Task<IReadOnlyList<RegistroVentaRow>> ObtenerRegistroVentaAsync(RegistroVentaParametros p, CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<RegistroVentaRow>>([]);
    public Task<IReadOnlyList<RegistroVentaSunatRow>> ObtenerRegistroVentaSunatAsync(RegistroVentaParametros p, CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<RegistroVentaSunatRow>>([]);
    public Task<IReadOnlyList<RegistroVentaSunatAdRow>> ObtenerRegistroVentaSunatAdAsync(RegistroVentaParametros p, CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<RegistroVentaSunatAdRow>>([]);
    public Task<IReadOnlyList<RegistroVentaDetalladoRow>> ObtenerRegistroVentaDetalladoAsync(RegistroVentaParametros p, CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<RegistroVentaDetalladoRow>>([]);
    public Task<IReadOnlyList<ReporteFiltroOpcion>> ObtenerTiposDocumentoAsync(CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<ReporteFiltroOpcion>>([]);
    public Task<IReadOnlyList<ReporteFiltroOpcion>> ObtenerEstadosDocumentoAsync(CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<ReporteFiltroOpcion>>([]);
    public Task<IReadOnlyList<ReporteFiltroOpcion>> ObtenerCajasActivasAsync(CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<ReporteFiltroOpcion>>([]);
    public Task<IReadOnlyList<ReporteFiltroOpcion>> ObtenerTiposPagoAsync(CancellationToken ct = default)
        => Task.FromResult<IReadOnlyList<ReporteFiltroOpcion>>([]);
}
