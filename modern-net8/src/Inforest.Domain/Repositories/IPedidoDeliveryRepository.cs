...
public interface IPedidoDeliveryRepository
{
    ...
    Task<IReadOnlyList<OperadorDespachoItem>> ObtenerEmpacadoresActivosDespachoAsync(CancellationToken cancellationToken = default);
    ...
    Task AsignarMotorizadoDespachoAsync(string codigoPedido, string codigoMotorizado, decimal tarifaDiaria, bool esTarifaExtra, CancellationToken cancellationToken = default);
    Task DesasignarMotorizadoDespachoAsync(string codigoPedido, string codigoMotorizado, bool liberarBanderaMotorizado, CancellationToken cancellationToken = default);
    Task AsignarEmpacadorDespachoAsync(string codigoPedido, string codigoEmpacador, CancellationToken cancellationToken = default);
    Task DesasignarEmpacadorDespachoAsync(string codigoPedido, CancellationToken cancellationToken = default);
    Task<int> ContarPedidosActivosMotorizadoAsync(string codigoMotorizado, CancellationToken cancellationToken = default);
