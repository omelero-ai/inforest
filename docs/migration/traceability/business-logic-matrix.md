...
| BR-006 | Validación de credenciales y permisos | `frmAcceso.frm`, `ClsSeguridad.cls`, `modSeguridadInfhotel.bas` | `TUSUARIO`, `TGRUPOUSUARIO`, `TACCESO`, `TGRUPOACCESO` | Seguridad | `Infrastructure/Auth` | ANALYSIS |
...
| BR-012 | Validación de licencia por hardkey | `License.cls`, `modSeguridadInfhotel.bas` | `THARDKEY`, `TPARAMETROVERSION` (INFSEGURIDAD) | Seguridad / Licencia | `Infrastructure/Licensing` | ANALYSIS |
