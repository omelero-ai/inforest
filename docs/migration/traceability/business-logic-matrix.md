...
| BR-009 | XML KDS por pedido/ítem/condimento | `modKDS.bas`, `frmCheffControl.frm` | `USP_KDS_ObtenerDetallePedidox`, `DPEDIDOKDS` | Cocina / KDS | `Application/IProduccionCocinaService`, `Infrastructure/Kitchen/KdsXmlDispatcher`, `Infrastructure/Kitchen/KdsLegacyGateway` | IN_PROGRESS |
| BR-010 | Routing de ítems a áreas de cocina | `frmPedido.frm`, `frmVenta.frm` | `TPRODUCTOAREA`, `TAREAIMPRESORA`, `DPEDIDO` | Cocina / Ventas | `Domain/Services/AreaProduccionRouter`, `Infrastructure/Kitchen/ComandaAreaDispatcher`, `Infrastructure/Kitchen/KitchenConfigurationProvider` | IN_PROGRESS |
