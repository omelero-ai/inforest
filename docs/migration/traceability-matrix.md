...
| `modPuntoVenta.bas` (`App.PrevInstance`) + `mdiPuntoVenta.frm` | Startup rule + Form MDI principal | `IAppInstanceGuard` + `AppInstanceGuard` + `Program.cs` + `FrmPuntoVenta` (MDI container, toolbar 21 botones incl. _btnSalir, StatusStrip 4 paneles, menú completo Movimientos/Correlativos/Reportes/Delivery/Conexión/Ayuda, LOG_SESIONES insert+update, ActivaInicio, timers reloj/BizLink/WebApp/Conexión/Actualizador, Salir() con auditoría, InicializaMCPVAsync, CmdSalir_Click, TimerActualizador_TickAsync, FrmActualizacion, ObtenerDiaContableAsync, IniciarNoticia, LiberarDescargoVenta, flags lAlmacen/lFacturacionE/lVisaNet/lSiab/lCajaRapida/lMultilocal/lMCPV) | Interface + Class + WinForm MDI | IN_PROGRESS | `modern-net8/src/Inforest.Application/Interfaces/IAppInstanceGuard.cs`, `modern-net8/src/Inforest.Infrastructure/Runtime/AppInstanceGuard.cs`, `modern-net8/src/Inforest.Desktop/Program.cs`, `modern-net8/src/Inforest.Desktop/POS/FrmPuntoVenta.cs`, `modern-net8/src/Inforest.Desktop/POS/FrmActualizacion.cs` — GAP remanentes: frmCancelado, frmServidorEnlace, frmGuiaTransporte, frmDocElectronicoCorrelativo, frmMozoUsuario, frmConsultaSaldo, frmRepRanking, frmRepClienteDeuda (GAP-MDI-001..008) |
