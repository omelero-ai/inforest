...
| `modPuntoVenta.bas` (`App.PrevInstance`) + `mdiPuntoVenta.frm` | Startup rule + Form MDI principal | `IAppInstanceGuard` + `AppInstanceGuard` + `Program.cs` + `FrmPuntoVenta` (MDI container, toolbar 20 botones, StatusStrip 4 paneles, menú completo Movimientos/Correlativos/Reportes/Delivery/Conexión/Ayuda, LOG_SESIONES insert+update, ActivaInicio, timers reloj/BizLink/WebApp/Conexión, Salir(), ObtenerDiaContableAsync, IniciarNoticia, LiberarDescargoVenta, flags lAlmacen/lFacturacionE/lVisaNet/lSiab/lCajaRapida/lMultilocal) | Interface + Class + WinForm MDI | COMPLETED | `modern-net8/src/Inforest.Application/Interfaces/IAppInstanceGuard.cs`, `modern-net8/src/Inforest.Infrastructure/Runtime/AppInstanceGuard.cs`, `modern-net8/src/Inforest.Desktop/Program.cs`, `modern-net8/src/Inforest.Desktop/POS/FrmPuntoVenta.cs` — GAP: frmAnulado, frmCancelado, frmServidorEnlace, frmGuiaTransporte, frmDocElectronicoCorrelativo, frmMozoUsuario, frmConsultaSaldo pendientes de migrar |
