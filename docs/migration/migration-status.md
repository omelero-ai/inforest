...
28. **RESUMEN INFOREST.VBP:** Forms 62/120 completados — 58 pendientes; Classes 6/10 completadas — 4 pendientes; Modules 4/18 completados — 14 pendientes; Funcionalidades POS 23/31 completadas — 8 pendientes; Reglas POS 41/52 migradas — 11 pendientes; SQL/Views/Tablas tratados 84/118 — 34 pendientes; Gaps documentados: 19.
29. **FORMULARIO ACTUAL:** `frmDespachador.frm` — MIGRATED. **SIGUIENTE PENDIENTE:** `frmPedidoDeliveryNo.frm` (seguimiento delivery no asignado), manteniendo la etapa actual.
30. Mantener seguimiento de gaps bloqueantes: HardKey físico, SecuGen, Epson fiscal y conectores FE/Rappi reales.
31. Completar plantillas FastReport pendientes para los handlers/reportes de Etapa 10 restantes.
