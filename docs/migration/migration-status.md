...
>
> Estado general: **Fase 4 IN_PROGRESS — W1-W15 completados; POS-FUNC-001..035 parcialmente migrados; baseline transversal + configuración + maestros + turno + pedidos + venta + caja + reportes + módulos POS + servicios de dominio + POS-FUNC-004 (frmSolicitudBoleta.frm MIGRATED) + POS-FUNC-021 (RFID completo MIGRATED: `FrmTarjetaProximidad` + `FrmRecargarTarjeta` + `FrmRecargarTarjetaDetalle` + `FrmMovimientoTarjetas` + BR-RFID-001..008; gap anticipo/documento abierto) + POS-FUNC-027 (frmCambio.frm MIGRATED) + POS-FUNC-028 (frmUpdateDatosPedido.frm MIGRATED) + POS-FUNC-029 (frmListaMotivos.frm MIGRATED) + POS-FUNC-019 (frmCambiarContrasenia.frm + frmPassword.frm COMPLETED) + POS-FUNC-035 (frmBusquedaRapida.frm MIGRATED: FrmBusquedaRapida genérico + BusquedaItem/BusquedaResultado + BR-BUSQ-001/002/003) — **570 tests en verde****
...
23. **SIGUIENTE PENDIENTE:** Cerrar equivalencia completa del bloque legacy de recarga (anticipo/emisión documental/impresión fiscal) dentro de POS-FUNC-021; o migrar `frmBusquedaDelivery.frm` (POS-FUNC-036).
