...
>
> Estado general: **Fase 4 IN_PROGRESS — W1-W15 completados; POS-FUNC-001..026 parcialmente migrados; baseline transversal + configuración + maestros + turno + pedidos + venta + caja + reportes + módulos POS + servicios de dominio + POS-FUNC-026 (frmDetallePedido + frmJuntarMesas MIGRATED: ObtenerDetallePedidoExtendidoHandler + IPedidoReadRepository extendido + PedidoRepository impl vPedidoDetalle/vPedidoCombo + FrmDetallePedido + FrmJuntarMesas + JuntarMesasResult + BR-PEDIDO-005/006 + BR-JUNTAR-001/002/003 + 8 tests — 529 tests en verde)**
...
16. Mantener seguimiento de gaps bloqueantes: HardKey físico, SecuGen, Epson fiscal y conectores FE/Rappi reales.
17. Completar plantillas FastReport pendientes para los handlers/reportes de Etapa 10 restantes.
