...
>
> Estado general: **Fase 4 IN_PROGRESS — W1-W15 completados; POS-FUNC-001..036 parcialmente migrados; baseline transversal + configuración + maestros + turno + pedidos + venta + caja + reportes + módulos POS + servicios de dominio + POS-FUNC-004 (frmSolicitudBoleta.frm MIGRATED) + POS-FUNC-021 (RFID completo MIGRATED: `FrmTarjetaProximidad` + `FrmRecargarTarjeta` + `FrmRecargarTarjetaDetalle` + `FrmMovimientoTarjetas` + BR-RFID-001..008; gap anticipo/documento abierto) + POS-FUNC-027 (frmCambio.frm MIGRATED) + POS-FUNC-028 (frmUpdateDatosPedido.frm MIGRATED) + POS-FUNC-029 (frmListaMotivos.frm MIGRATED) + POS-FUNC-019 (frmCambiarContrasenia.frm + frmPassword.frm COMPLETED) + POS-FUNC-035 (frmBusquedaRapida.frm MIGRATED) + POS-FUNC-036 (frmBusquedaDelivery.frm MIGRATED: FrmBusquedaDelivery + IClienteDeliveryReadRepository + EstadisticasClienteDelivery + BR-DEL-036-001..005) — **577 tests en verde****
