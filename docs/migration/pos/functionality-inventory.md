...
|---|---|---|---|---|
| POS-FUNC-001 | Inicio de sesión POS | `frmAcceso.frm + modPuntoVenta.bas` | Autenticar usuario y habilitar MDI POS | ANALYSIS |
...
| POS-FUNC-008 | Caja y cierre | `frmCajaRapida.frm / frmLiquidacionDetalle.frm` | Control de caja y liquidaciones | ANALYSIS |
