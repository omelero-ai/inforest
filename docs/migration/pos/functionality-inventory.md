...
| POS-FUNC-024 | Fiscal Epson (Argentina) | `modImpresoraFiscal.bas + IFEpson.ocx` | Comprobación fiscal hardware | EXCLUDED_BY_SCOPE || POS-FUNC-030 | Mapa Visual de Mesas | `frmMesas.frm` | Mapa interactivo de salones y mesas con color coding por estado; selector de mesa para nuevo pedido | MIGRATED |
