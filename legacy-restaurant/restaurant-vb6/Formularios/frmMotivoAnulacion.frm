...
Begin VB.Form frmMotivoAnulacion 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   8175
   ClientLeft      =   2535
   ClientTop       =   1725
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "frmMotivoAnulacion.frx":0000
            Style           =   1  'Graphical
            TabIndex        =   21
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmMotivoAnulacion.frx":0542
            Style           =   1  'Graphical
            TabIndex        =   20
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmMotivoAnulacion.frx":0A84
            Style           =   1  'Graphical
            TabIndex        =   19
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "frmMotivoAnulacion.frx":0FC6
            Style           =   1  'Graphical
            TabIndex        =   18
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "frmMotivoAnulacion.frx":1508
            Style           =   1  'Graphical
            TabIndex        =   17
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "frmMotivoAnulacion.frx":1A4A
            Style           =   1  'Graphical
            TabIndex        =   16
            TabStop         =   0   'False
            Top             =   0
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5895
         Picture         =   "frmMotivoAnulacion.frx":1F8C
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Agrega"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6480
         Picture         =   "frmMotivoAnulacion.frx":24BE
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton cmdEmite 
         ...
         Height          =   555
         Left            =   7065
         Picture         =   "frmMotivoAnulacion.frx":25C0
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Emite"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   8820
         Picture         =   "frmMotivoAnulacion.frx":2AF2
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Salir"
         Top             =   90
      ...
      Begin VB.CommandButton cmdProcesa 
         ...
         Height          =   555
         Left            =   13095
         Picture         =   "frmMotivoAnulacion.frx":2BE4
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Filtrar"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   8235
         Picture         =   "frmMotivoAnulacion.frx":2CE6
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   7650
         Picture         =   "frmMotivoAnulacion.frx":3218
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "frmMotivoAnulacion"
...
Private Sub cmdOpcion_Click(Index As Integer)
 Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmMotivoAnulacionDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "select * from vMotivoAnulacion where Codigo <>'000'"
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmMotivoAnulacion = Nothing
End Sub
