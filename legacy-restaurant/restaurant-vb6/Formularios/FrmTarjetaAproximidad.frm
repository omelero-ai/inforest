...
Begin VB.Form FrmTarjetaAproximidad 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Form1"
   ClientHeight    =   8190
   ClientLeft      =   60
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   8320
         Picture         =   "FrmTarjetaAproximidad.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   7740
         Picture         =   "FrmTarjetaAproximidad.frx":0532
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton cmdProcesa 
         ...
         Height          =   555
         Left            =   13180
         Picture         =   "FrmTarjetaAproximidad.frx":0A64
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Filtrar"
         Top             =   55
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   8900
         Picture         =   "FrmTarjetaAproximidad.frx":0B66
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Salir"
         Top             =   55
      ...
      Begin VB.CommandButton cmdEmite 
         ...
         Index           =   0
         Left            =   7150
         Picture         =   "FrmTarjetaAproximidad.frx":0C58
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Emite"
         Top             =   55
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6580
         Picture         =   "FrmTarjetaAproximidad.frx":118A
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   6020
         Picture         =   "FrmTarjetaAproximidad.frx":128C
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Agrega"
         Top             =   55
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "FrmTarjetaAproximidad.frx":17BE
            Style           =   1  'Graphical
            TabIndex        =   9
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "FrmTarjetaAproximidad.frx":1D00
            Style           =   1  'Graphical
            TabIndex        =   8
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "FrmTarjetaAproximidad.frx":2242
            Style           =   1  'Graphical
            TabIndex        =   7
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "FrmTarjetaAproximidad.frx":2784
            Style           =   1  'Graphical
            TabIndex        =   6
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "FrmTarjetaAproximidad.frx":2CC6
            Style           =   1  'Graphical
            TabIndex        =   5
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "FrmTarjetaAproximidad.frx":3208
            Style           =   1  'Graphical
            TabIndex        =   4
            TabStop         =   0   'False
            Top             =   0
   ...
   End
End
Attribute VB_Name = "FrmTarjetaAproximidad"
...
Select Case Index
           Case Is = 0  'Nuevo
                ...
                FrmTarjetaAproximidadDetalle.Show vbModal
           ...
           Case Is = 5 'imprimir
                ...
                If RsCabecera.RecordCount > 0 Then
                   sDocumento = RsCabecera!CodidoRFID
                   
                   Dim xclie As String
                   xclie = RsCabecera!Cliente
                   ...
                   Genera (sDocumento)
                    ...
                    nCantidad = RsReporte.RecordCount
                   
                    Imprimir ("001")
                    Printer.FontName = sFont
                    Printer.FontBold = False
                      'Cabecera
                    ImprimeXCentro "Movimientos de Tarjeta", 40
      
                    Printer.Print ""
                    Printer.Print "Cliebte: " & xclie
                    Printer.Print "Tarjeta: " & sDocumento
                    Printer.Print "Fecha  : " & Date & " " & Time
                    Printer.Print String(40, "-")
                     Printer.Print ""
                    'Detalle
                    Printer.Print "Fecha      M.Ing   M.Sal   M.Ante  M.Fin"
                    
                    RsReporte.MoveFirst
                    Do While Not RsReporte.EOF
                          sLinea = RsReporte!fRegistro & "   " & RsReporte!MontoIngreso & "     " & RsReporte!MontoSalida & "       " & RsReporte!MontoAnterior & "   " & RsReporte!MontoFinal
                          If sLinea <> "" Then
    ...
    End Select
End Sub
Public Sub Genera(tarjeta As String)
 Screen.MousePointer = vbHourglass
 
  'Select del Reporte
   Isql = "SELECT top 10 convert(date,fRegistro)fRegistro, MontoIngreso,MontoSalida,MontoAnterior, MontoFinal  FROM TMOVIMIENTOTARJETASRFID where CodidoRFID = '" & tarjeta & "' order by fregistro desc "
...
Screen.MousePointer = vbHourglass
    ...
    nColumna = 0
     ...
     'Ingrese la Vista
    Isql = "select t1.id, t1.CodidoRFID,t1.fRegistro,t1.UsuarioRegistro,t1.FechaModificion,t1.UsuarioModificion,t1.Estado,t1.MontoDisponible,t1.Descripcion,t1.CodigoCliente,t2.tApellido + ' '+ t2.tNombre as cliente   from TTARJETASRFID t1 inner join TDELIVERY t2 on t1.CodigoCliente = t2.tCodigoDelivery"
           
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(6, grdGrilla, "Codigo Tarjeta", 2, "CodidoRFID", 2100, 2, 0, "", _
                                  "Descripción Detallada", 2, "Descripcion", 2500, 0, 0, "", _
                                  "Monto", 2, "MontoDisponible", 1180, 1, 0, "###,##0.00", _
                                  "Codigo Cliente.", 2, "CodigoCliente", 1000, 2, 0, "", _
                                  "Cliente.", 2, "Cliente", 4500, 0, 0, "", _
                                  "Activo", 2, "estado", 1100, 2, 0, "")
...
Private Sub Form_Unload(Cancel As Integer)
    Set FrmTarjetaAproximidad = Nothing
End Sub
