...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "SELECT DISTINCT Codigo, Descripcion, Operador, tResumido, lActivo, tOperador, lValor, lStockMas, lStockMenos, nControl, nPrecio, tEnlace, tArea, lsolicitaCantidad, lActivoPatio, tcodigoexterno, lActivoTotem from vPropiedad order by Codigo"
