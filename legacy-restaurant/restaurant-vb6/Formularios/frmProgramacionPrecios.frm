...
Begin VB.Form frmProgramacionPrecios 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Programación de Cambios de Precios"
   ClientHeight    =   8145
   ClientLeft      =   2535
   ClientTop       =   345
   ClientWidth     =   13710
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmProgramacionPrecios.frx":0542
            Style           =   1  'Graphical
            TabIndex        =   20
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmProgramacionPrecios.frx":0A84
            Style           =   1  'Graphical
            TabIndex        =   19
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "frmProgramacionPrecios.frx":0FC6
            Style           =   1  'Graphical
            TabIndex        =   18
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "frmProgramacionPrecios.frx":1508
            Style           =   1  'Graphical
            TabIndex        =   17
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "frmProgramacionPrecios.frx":1A4A
            Style           =   1  'Graphical
            TabIndex        =   16
            TabStop         =   0   'False
            Top             =   0
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5880
         Picture         =   "frmProgramacionPrecios.frx":1F8C
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Agrega"
         Top             =   65
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6480
         Picture         =   "frmProgramacionPrecios.frx":24BE
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton cmdEmite 
         ...
         Height          =   555
         Left            =   7800
         Picture         =   "frmProgramacionPrecios.frx":25C0
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Emite"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   7060
         Picture         =   "frmProgramacionPrecios.frx":2AF2
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Salir"
         Top             =   65
      ...
      Begin VB.CommandButton cmdProcesa 
         ...
         Height          =   555
         Left            =   13095
         Picture         =   "frmProgramacionPrecios.frx":2BE4
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Filtrar"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   8235
         Picture         =   "frmProgramacionPrecios.frx":2CE6
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   8040
         Picture         =   "frmProgramacionPrecios.frx":3218
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin VB.Frame fraGrilla 
      ...
      Begin TrueOleDBGrid80.TDBGrid grdGrilla 
         ...
         _StyleDefs(20)  =   "Splits(0).Style:id=26,.parent=1,.namedParent=33"
         _StyleDefs(21)  =   "Splits(0).CaptionStyle:id=61,.parent=4"
         _StyleDefs(22)  =   "Splits(0).HeadingStyle:id=27,.parent=2"
         _StyleDefs(23)  =   "Splits(0).FooterStyle:id=28,.parent=3"
         _StyleDefs(24)  =   "Splits(0).InactiveStyle:id=29,.parent=5"
         _StyleDefs(25)  =   "Splits(0).SelectedStyle:id=57,.parent=6,.bgcolor=&HE7FAB6&,.fgcolor=&H80000009&"
         _StyleDefs(26)  =   "Splits(0).EditorStyle:id=56,.parent=7"
         _StyleDefs(27)  =   "Splits(0).HighlightRowStyle:id=58,.parent=8"
         _StyleDefs(28)  =   "Splits(0).EvenRowStyle:id=59,.parent=9"
         _StyleDefs(29)  =   "Splits(0).OddRowStyle:id=60,.parent=10"
         _StyleDefs(30)  =   "Splits(0).RecordSelectorStyle:id=62,.parent=11"
         _StyleDefs(31)  =   "Splits(0).FilterBarStyle:id=67,.parent=12"
         _StyleDefs(32)  =   "Splits(0).Columns(0).Style:id=71,.parent=26"
         _StyleDefs(33)  =   "Splits(0).Columns(0).HeadingStyle:id=68,.parent=27,.alignment=0"
         _StyleDefs(34)  =   "Splits(0).Columns(0).FooterStyle:id=69,.parent=28"
         _StyleDefs(35)  =   "Splits(0).Columns(0).EditorStyle:id=70,.parent=56"
...
Private Sub cmdOpcion_Click(Index As Integer)
  Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmProgramacionPreciosDetalle.Show vbModal
...
Screen.MousePointer = vbHourglass
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Programación de Cambios de Precios "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 0
    
    ' Ingrese la Vista
    Isql = "select tCodigoProgPrecio, tNomProgPrecio, fecha, hora, lActivo, lConfirmado,lAplicado,  tUsuario, fRegistro,tUsuarioConfirma,fRegistroConfirma, tUsuarioAplica, fRegistroAplica,PorceAumento , PorceDescuento from TPROGRAMAPRECIOS_CAB"
    
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(15, grdGrilla, "Codigo", 2, "tCodigoProgPrecio", 800, 2, 0, "", _
                                  "Descripción", 2, "tNomProgPrecio", 3100, 0, 0, "", _
                                  "Fecha", 2, "fecha", 1300, 0, 0, "dd MMMM", _
                                  "Hora", 2, "hora", 700, 2, 0, "", _
                                  "Estado", 2, "lActivo", 800, 2, 4, "", _
                                  "Confirmado", 2, "lConfirmado", 1250, 2, 4, "", _
                                  "Aplicado", 2, "lAplicado", 1000, 2, 4, "", _
                                  "Usuario Conf", 2, "tUsuarioConfirma", 1400, 0, 0, "", _
                                  "Fecha Conf", 2, "fRegistroConfirma", 2300, 0, 0, "", _
                                  "Usuario Apli", 2, "tUsuarioAplica", 1400, 0, 0, "", _
                                  "Fecha Apli", 2, "fRegistroAplica", 2300, 0, 0, "", _
                                  "% +", 2, "PorceAumento", 1000, 2, 0, "", _
                                  "% -", 2, "PorceDescuento", 1000, 2, 0, "", _
                                  "Usuario", 2, "tUsuario", 1400, 2, 0, "", _
                                  "Registro", 2, "fRegistro", 2300, 2, 0, "")
