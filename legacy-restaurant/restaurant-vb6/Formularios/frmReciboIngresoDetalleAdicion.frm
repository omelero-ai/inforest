...
Begin VB.Form frmReciboIngresoDetalle 
   ...
   ClientTop       =   2640
   ClientWidth     =   9930
   Icon            =   "frmReciboIngresoDetalleAdicion.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5925
   ...
   Begin VB.Frame fraDetalle 
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   4
         Left            =   6720
         Picture         =   "frmReciboIngresoDetalleAdicion.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   3075
         Width           =   1170
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   6720
         Picture         =   "frmReciboIngresoDetalleAdicion.frx":040C
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   4200
         Width           =   1170
   ...
   Begin VB.PictureBox Picture 
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5100
         Picture         =   "frmReciboIngresoDetalleAdicion.frx":050E
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   60
         Width           =   1170
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   3
         Left            =   8640
         Picture         =   "frmReciboIngresoDetalleAdicion.frx":0A40
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   60
         Width           =   1170
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   2
         Left            =   7440
         Picture         =   "frmReciboIngresoDetalleAdicion.frx":0B32
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   60
         Width           =   1170
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6270
         Picture         =   "frmReciboIngresoDetalleAdicion.frx":0C34
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   60
         Width           =   1170
      ...
      Begin VB.PictureBox PicNavegacion 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   480
            Picture         =   "frmReciboIngresoDetalleAdicion.frx":1166
            Style           =   1  'Graphical
            TabIndex        =   7
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   960
            Picture         =   "frmReciboIngresoDetalleAdicion.frx":16A8
            Style           =   1  'Graphical
            TabIndex        =   6
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmReciboIngresoDetalleAdicion.frx":1BEA
            Style           =   1  'Graphical
            TabIndex        =   5
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   4440
            Picture         =   "frmReciboIngresoDetalleAdicion.frx":212C
            Style           =   1  'Graphical
            TabIndex        =   4
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   3960
            Picture         =   "frmReciboIngresoDetalleAdicion.frx":266E
            Style           =   1  'Graphical
            TabIndex        =   3
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   3480
            Picture         =   "frmReciboIngresoDetalleAdicion.frx":2BB0
            Style           =   1  'Graphical
            TabIndex        =   2
            TabStop         =   0   'False
            Top             =   0
   ...
   Begin VB.Image Image 
      Height          =   5115
      Left            =   60
      Picture         =   "frmReciboIngresoDetalleAdicion.frx":30F2
      Stretch         =   -1  'True
      Top             =   60
      Width           =   1785
   End
