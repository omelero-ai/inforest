...
Begin VB.Form FrmRecargarTarjeta 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   8820
   ClientLeft      =   -3525
   ClientTop       =   -1125
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   8
         Left            =   7560
         Picture         =   "FrmRecargarTarjeta.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5640
         Picture         =   "FrmRecargarTarjeta.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   21
         ToolTipText     =   "Agrega"
         Top             =   90
      ...
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   6240
         Picture         =   "FrmRecargarTarjeta.frx":0974
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton cmdProcesa 
         Height          =   555
         Left            =   13920
         Picture         =   "FrmRecargarTarjeta.frx":0EA6
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Filtrar"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   14
         Left            =   17685
         Picture         =   "FrmRecargarTarjeta.frx":0FA8
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Salir"
         Top             =   -450
      ...
      Begin VB.CommandButton cmdEmite 
         ...
         Height          =   555
         Left            =   8160
         Picture         =   "FrmRecargarTarjeta.frx":109A
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Emite"
         Top             =   90
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   3690
            Picture         =   "FrmRecargarTarjeta.frx":15CC
            Style           =   1  'Graphical
            TabIndex        =   10
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4230
            Picture         =   "FrmRecargarTarjeta.frx":1B0E
            Style           =   1  'Graphical
            TabIndex        =   9
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   4770
            Picture         =   "FrmRecargarTarjeta.frx":2050
            Style           =   1  'Graphical
            TabIndex        =   8
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "FrmRecargarTarjeta.frx":2592
            Style           =   1  'Graphical
            TabIndex        =   7
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "FrmRecargarTarjeta.frx":2AD4
            Style           =   1  'Graphical
            TabIndex        =   6
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "FrmRecargarTarjeta.frx":3016
            Style           =   1  'Graphical
            TabIndex        =   5
            TabStop         =   0   'False
            Top             =   0
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   6840
         Picture         =   "FrmRecargarTarjeta.frx":3558
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Salir"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "FrmRecargarTarjeta"
...
Private Sub cmdOpcion_Click(Index As Integer)
  Select Case Index
           Case Is = 0  'Nuevo
                ...
                FrmRecargarTarjetaDetalle.Show vbModal
...
Private Sub cmdProcesa_Click()
 Screen.MousePointer = vbHourglass
   ...
   Isql = "exec usp_Inforest_ObtieneRecargas '" & Format(dtpFecIni.value, "yyyy/MM/dd") & " 00:00', '" & Format(dtpFecFin.value, "yyyy/MM/dd") & " 23:59', 'R', '" & 1 & "', '" & 1 & "' "
...
'    Isql = "exec usp_Inforest_ObtieneDocumentos '" & Format(dtpFecIni.value, "yyyy/MM/dd") & " 00:00', '" & Format(dtpFecFin.value, "yyyy/MM/dd") & " 23:59', '" & sCaja & "'"
    ...
    Call ConfGrilla(9, grdGrilla, "Correlativo", 2, "id", 500, 2, 0, "", _
                                   "Tarjeta", 2, "CODIDORFID", 2200, 0, 0, "", _
                                    "tipo", 2, "tipo", 800, 0, 0, "", _
                                    "Doc Referencia", 2, "docreferencia", 2500, 0, 0, "@-@@@@@-@@@@@@@@@", _
                                   "Fec.Emis", 2, "fregistro", 2100, 0, 0, "dd/mm/yyyy", _
                                   "Monto ingreso", 2, "montoingreso", 1500, 1, 0, "###,###,##0.00", _
                                   "Monto salida", 2, "montosalida", 1500, 1, 0, "###,##0.00", _
                                   "Monto anterior", 2, "montoanterior", 1500, 1, 0, "###,##0.00", _
                                   "Monto final", 2, "montofinal", 1500, 1, 0, "###,##0.00")
...
'    Set FrmRecargarTarjeta = Nothing
End Sub
