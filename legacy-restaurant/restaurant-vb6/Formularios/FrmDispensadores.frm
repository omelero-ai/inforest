...
Begin VB.Form FrmDispensadores 
   BackColor       =   &H00C0C0C0&
   ClientHeight    =   8190
   ClientLeft      =   60
   ClientTop       =   345
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "FrmDispensadores.frx":0000
            Style           =   1  'Graphical
            TabIndex        =   21
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "FrmDispensadores.frx":0542
            Style           =   1  'Graphical
            TabIndex        =   20
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "FrmDispensadores.frx":0A84
            Style           =   1  'Graphical
            TabIndex        =   19
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "FrmDispensadores.frx":0FC6
            Style           =   1  'Graphical
            TabIndex        =   18
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "FrmDispensadores.frx":1508
            Style           =   1  'Graphical
            TabIndex        =   17
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "FrmDispensadores.frx":1A4A
            Style           =   1  'Graphical
            TabIndex        =   16
            TabStop         =   0   'False
            Top             =   0
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   0
         Left            =   5980
         Picture         =   "FrmDispensadores.frx":1F8C
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Agrega"
         Top             =   55
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6550
         Picture         =   "FrmDispensadores.frx":24BE
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton cmdEmite 
         ...
         Height          =   555
         Left            =   7120
         Picture         =   "FrmDispensadores.frx":25C0
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Emite"
         Top             =   55
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   8260
         Picture         =   "FrmDispensadores.frx":2AF2
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Salir"
         Top             =   55
      ...
      Begin VB.CommandButton cmdProcesa 
         ...
         Height          =   555
         Left            =   13095
         Picture         =   "FrmDispensadores.frx":2BE4
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Filtrar"
         Top             =   90
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   5
         Left            =   8880
         Picture         =   "FrmDispensadores.frx":2CE6
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   7680
         Picture         =   "FrmDispensadores.frx":3218
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "FrmDispensadores"
...
Select Case Index
           Case Is = 0  'Nuevo
                ...
                FrmDispensadoresDetalle.Show vbModal
...
Private Sub Form_Load()
 Screen.MousePointer = vbHourglass
    ...
    nColumna = 0
     ...
     'Ingrese la Vista
    Isql = " select * from TDISPENSADOR"
           
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(6, grdGrilla, "Codigo", 2, "id", 850, 2, 0, "", _
                                  "Descripción Detallada", 2, "Descripcion", 2500, 0, 0, "", _
                                  "Codigo Producto", 2, "codigoproducto", 2000, 0, 0, "", _
                                  "TopeMax.", 2, "topemax", 2000, 0, 0, "", _
                                  "Codigo Externo", 2, "codigoexterno", 2000, 0, 0, "", _
                                  "Activo", 2, "estado", 900, 2, 4, "")
