...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           Case Is = 0  'Nuevo
                ...
                frmTerminalDetalle.Show vbModal
...
Private Sub Form_Load()
    ...
    ' Ingrese el Titulo
    Me.Caption = " Mantenimiento de Terminales "
    grdGrilla.Caption = Me.Caption
    Centrar Me
    nColumna = 2
    
    Isql = "SELECT TT2.tValor as integracion,TT1.* FROM TTERMINAL TT1 INNER JOIN TTABLA TT2 ON TT1.tIntegracion = TT2.TCODIGO WHERE TT2.TTABLA = 'INTEGRACION'"
    
    Set RsCabecera = Lib.OpenRecordset(Isql, Cn)
    
    'Configuración de la Grilla
    Call ConfGrilla(3, grdGrilla, "Codigo", 2, "Codigo", 2000, 0, 0, "", _
                                    "Integracion", 2, "integracion", 2700, 0, 0, "", _
                                    "Terminal", 2, "tTerminal", 3000, 0, 0, "")
