...
Private Sub Form_Load()
    ...
    Isql = "select tCodigoTarjeta, tDetallado, nFactorRetencion, lActivo, tResumido, tTelefono1, tTelefono2, tRepresentante, nBoton, tCuentaContable, lPinPad, str(nFactorRetencion,10,2) as xFactorRetencion, tCodTarjetaEx, isnull(tCodigoIntegracion,0) as tCodigoIntegracion from TTARJETACREDITO"
