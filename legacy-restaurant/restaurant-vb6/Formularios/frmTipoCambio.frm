...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    Isql = "select fFecha, nCompra, nVenta, tUsuario, fRegistro, IsNull(nOficial,0)as nOficial,IsNull(nVenta2,0) as nVenta2,IsNull(nVenta3,0) as nVenta3, " & _
           "convert(varchar, fFecha, 103) as xFecha, str(nCompra,10,3) as xCompra, str(nVenta,10,3) as xVenta, convert(varchar, fRegistro, 103) as xRegistro, str(nOficial,10,3) as xOficial, str(nVenta2,10,3) as xVenta2 , str(nVenta3,10,3) as xVenta3 " & _
           "from TTIPOCAMBIO"
    ...
    If pais = "003" Then
        ...
        Call ConfGrilla(5, grdGrilla, "Fecha", 2, "xFecha", 2100, 2, 0, "dd/mm/yyyy", _
                                      "Venta ME1", 2, "xVenta", 2100, 1, 0, "##0.000", _
                                      "Venta ME2", 2, "xVenta2", 2100, 1, 0, "##0.000", _
                                      "Venta ME3", 2, "xVenta3", 2100, 1, 0, "##0.000", _
