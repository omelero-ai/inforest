...
Begin VB.Form frmReciboIngreso 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Width           =   555
      End
      Begin VB.CommandButton cmdConsumo 
         Caption         =   "Consumo"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   1
            Left            =   540
            Picture         =   "frmReciboIngreso.frx":083C
            Style           =   1  'Graphical
            TabIndex        =   1
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   2
            Left            =   1080
            Picture         =   "frmReciboIngreso.frx":0D7E
            Style           =   1  'Graphical
            TabIndex        =   2
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frmReciboIngreso.frx":12C0
            Style           =   1  'Graphical
            TabIndex        =   0
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   5
            Left            =   5250
            Picture         =   "frmReciboIngreso.frx":1802
            Style           =   1  'Graphical
            TabIndex        =   5
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   4
            Left            =   4710
            Picture         =   "frmReciboIngreso.frx":1D44
            Style           =   1  'Graphical
            TabIndex        =   4
            TabStop         =   0   'False
            Top             =   0
         ...
         Begin VB.CommandButton cmdNavegar 
            ...
            Index           =   3
            Left            =   4170
            Picture         =   "frmReciboIngreso.frx":2286
            Style           =   1  'Graphical
            TabIndex        =   3
            TabStop         =   0   'False
            Top             =   0
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   1
         Left            =   6480
         Picture         =   "frmReciboIngreso.frx":2CFA
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdOpcion 
         ...
         Index           =   6
         Left            =   9375
         Picture         =   "frmReciboIngreso.frx":332E
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Salir"
         Top             =   90
      ...
      Begin VB.CommandButton cmdProcesa 
         Height          =   555
         Left            =   5880
         Picture         =   "frmReciboIngreso.frx":3420
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Filtrar"
         Top             =   810
      ...
      Begin VB.CommandButton cmdExporta 
         Height          =   555
         Left            =   7650
         Picture         =   "frmReciboIngreso.frx":3A54
         Style           =   1  'Graphical
         TabIndex        =   9
...
On Error GoTo fin
   ...
   Isql = "select tRecibo, nCorrelativo, monto, fRegistro, tUsuario, tCaja, tTurno, tDocumento from     dbo.DINGRESO where trecibo ='" & RsCabecera!tRecibo & "' order by fRegistro"
   frmBusca.nPredeterm = 1
   Call ConfGrilla(8, frmBusca.grdGrilla, "Recibo", 2, "tRecibo", 1000, 0, 0, "", _
                                          "Corr", 2, "nCorrelativo", 500, 2, 0, "", _
                                          "Monto", 2, "Monto", 1000, 1, 0, "", _
                                          "Fecha", 2, "fRegistro", 1600, 0, 0, "", _
                                          "Usuario", 2, "tUsuario", 800, 0, 0, "", _
                                          "Caja", 2, "tCaja", 600, 2, 0, "", _
                                          "Turno", 2, "tTurno", 0, 0, 0, "", _
                                          "Documento", 2, "tDocumento", 1500, 0, 0, "")
...
Private Sub cmdOpcion_Click(Index As Integer)
    Select Case Index
           ...
           Case Is = 10
                'reimpresion
                Dim RsIngresoReimpresion As Recordset
                ...
                With RsCabecera
                    If .RecordCount <> 0 Then
                        ...
                        If lActivaReciboSaldoQr Then
                          ValorQR = Format(FechaServidor(), "yyyyMMdd") & "|" & Format(FechaServidor(), "HHmmss") & "|" & !xMonto & "|" & !tRecibo & "|" & sUsuario & "|" & sCaja & "|" & sTurno
                          Me.Picture2.Picture = LoadPicture(CrearImagenQR_Comanda(ValorQR))
                        End If
                        ...
                        Isql = "select tRecibo, tTurno, fFecha, tMoneda, nMonto, tDescripcion, tAutoriza, tEstadoDocumento, tUsuario, fRegistro, estadodocumento as Estado, Moneda, treferencia, ttipopago,ttarjeta,lanticipo, str(nMonto,10,2) as xMonto, convert(varchar, fFecha, 103) as xFecha,TipoPago from vingreso " & _
                                  "where tRecibo = '" & !tRecibo & "'"
    
                        Set RsIngresoReimpresion = Lib.OpenRecordset(Isql, Cn)
                        
                        ImprimeReciboIngreso RsIngresoReimpresion, Picture2
...
Private Sub Form_Load()
    ...
    ' Ingrese la Vista
    If lMCPV Then
       Isql = "select tRecibo, tTurno, fFecha, tMoneda, nMonto, tDescripcion, tAutoriza, tEstadoDocumento, tUsuario, fRegistro, estadodocumento as Estado, Moneda, treferencia, ttipopago,ttarjeta,lanticipo, str(nMonto,10,2) as xMonto, convert(varchar, fFecha, 103) as xFecha, pedido, Saldo from vingreso " & _
              "where tUsuario='" & sUsuario & "' and fregistro >= '" & Format(dtpFecIni.value, "yyyy/MM/dd") & " " & Format(dtpHorIni.value, "HH:mm") & "' and fregistro <= '" & Format(dtpFecFin.value, "yyyy/MM/dd") & " " & Format(Me.dtpHorFin.value, "HH:mm") & "'"
    Else
       Isql = "select tRecibo, tTurno, fFecha, tMoneda, nMonto, tDescripcion, tAutoriza, tEstadoDocumento, tUsuario, fRegistro, estadodocumento as Estado, Moneda, treferencia, ttipopago,ttarjeta,lanticipo, str(nMonto,10,2) as xMonto, convert(varchar, fFecha, 103) as xFecha, pedido, Saldo from vingreso " & _
              "where fregistro >= '" & Format(dtpFecIni.value, "yyyy/MM/dd") & " " & Format(dtpHorIni.value, "HH:mm") & "' and fregistro <= '" & Format(dtpFecFin.value, "yyyy/MM/dd") & " " & Format(Me.dtpHorFin.value, "HH:mm") & "'"
    ...
    Call ConfGrilla(11, grdGrilla, "Recibo", 2, "tRecibo", 1200, 0, 0, "", _
                                  "Fecha", 2, "xFecha", 1200, 0, 0, "", _
                                  "Mon", 2, "Moneda", 550, 2, 0, "", _
                                  "Monto", 2, "xMonto", 1100, 1, 0, "", _
                                  "Anticipo", 2, "lAnticipo", 700, 2, 4, "", _
                                  "Descripción", 2, "tDescripcion", 3400, 0, 0, "", _
                                  "Autoriza", 2, "tAutoriza", 1600, 0, 0, "", _
                                  "Estado", 2, "Estado", 1000, 0, 0, "", _
                                  "Turno", 2, "tTurno", 1200, 0, 0, "", _
                                  "Ped. Refer.", 2, "pedido", 1200, 0, 0, "", _
                                  "Saldo", 2, "Saldo", 1100, 0, 0, "")
                                    
    If Not lActivaReciboSaldoQr Then
        grdGrilla.Columns(10).Visible = False
